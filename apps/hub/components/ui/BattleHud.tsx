...
export function BattleHud({ round, trick, timer, onExit, className }: BattleHudProps) {
  return (
    <header className={mergeClassNames("battle-hud layer-hud flex flex-wrap items-center justify-between gap-4 rounded-3xl border border-white/10 bg-black/30 px-6 py-4 backdrop-blur-sm", className)}>
